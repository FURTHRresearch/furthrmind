...
export default function ExperimentPage(props) {
    ...
    const {data, mutate} = useSWR(`/web/item/experiments/${expid}`, fetcher);
                ...
                <div style={{marginRight: marginRight, marginLeft: marginLeft}}>
                    ...
                    <div>
                        <Grid container spacing={3}>
                            <Grid item xs={4}>
                                <ResearchItemCard type='experiments' itemId={expid} group={group} project={project}
                                                  expanded={true} groups={groups} mutateGroups={mutateGroups}/>
                            </Grid>
                            <Grid item xs={8}>
                                ...
                                {notebooks && !notebooks.length && (<Paper sx={{padding: '32px 32px'}}>
                                    ...
                                    <Stack alignItems='center' justifyContent='center' my={5} spacing={2}>
                                        ...
                                        <div className={classes.heading}
                                             style={{fontSize: '14px', fontWeight: '400'}}> This experiment doesn't have
                                            any notebooks. Try adding a notebook field.
                                        </div>
                                        <Button variant="contained" onClick={() => setHideAddNewField(false)}>Add a
                                            notebook</Button>
                                    </Stack>
                                    {
