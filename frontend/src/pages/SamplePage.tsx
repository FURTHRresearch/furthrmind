...
export default function SamplePage(props) {
    ...
    const {data, mutate} = useSWR(`/web/item/samples/${sampleid}`, fetcher);
                ...
                <div style={{marginRight: marginRight, marginLeft: marginLeft}}>
                    ...
                    <div>
                        <Grid container spacing={3}>
                            <Grid item xs={4}>
                                <ResearchItemCard type='samples' itemId={sampleid} group={group} project={project}
                            ...
                            <Grid item xs={8}>
                                ...
                                {notebooks && !notebooks.length && (<Paper sx={{padding: '32px 32px'}}>
                                    ...
                                    <Stack alignItems='center' justifyContent='center' my={5} spacing={2}>
                                        ...
                                        <div className={classes.heading}
                                             style={{fontSize: '14px', fontWeight: '400'}}> This sample doesn't have any
                                            notebooks. Try adding a notebook field.
                                        </div>
